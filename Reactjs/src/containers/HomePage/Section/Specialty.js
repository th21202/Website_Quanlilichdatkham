            ...
            < section>
                <div className="container">
                  <div className="xl:w-[950px] mx-auto">
                    <h2 className="heading text-center"><FormattedMessage id="homepage.specialty-popular" /></h2>
                    <p className="text_para text-center">
                      <FormattedMessage id="homepage.specialty-popular-text" />
                    </p>
                    </div>
                </div>
            </section>
                      ...
                      <div class="col-lg-3 col-auto my-10">
                          <div class="card-bs-custom pointer" onClick={() => this.handleViewDetailSpecialty(item)}>
                            <figure class="bg-cover bg-center" 
                              ...
                              <div class="card-body">
                                  {/* <h3 class="card-bmb-5  pointer specialty-name ody" >{item.name}</h3> */}
                                  <div class="specialty-name" >{item.name}</div>
                              </div>
                          </div>
                      </div>
                    );
