          ...
          <div className="section-share section-medical-facility">
            <div className="section-container">
              {/* <div className="section-header">
                {/* <span className="title-section"><FormattedMessage 
                id="homepage.outstanding-medical-facility" /></span> 
                <button
              ...
              <section>
                ...
                <div className="container">
                  <div className="xl:w-[950px] mx-auto">
                    <h2 className="heading text-center"><FormattedMessage id="homepage.outstanding-medical-facility" /></h2>
                    <p className="text_para text-center">
                      <FormattedMessage id="homepage.outstanding-medical-facility-text" />
                    </p>
                    </div>
                </div>
              </section>
                      ...
                      <div class="col-lg-3 col-auto my-10">
                          <div class="card-bs-custom pointer" onClick={() => this.handleViewDetailClinic(item)}>
                            <figure class="bg-cover bg-center" 
                              ...
                              <div class="card-body">
                                  <h3 class="mb-5  pointer specialty-name fs-15" >{item.name}</h3>
                              </div>
                          </div>
                      </div>
                    );
